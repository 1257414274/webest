...
from domain_admin.api import (
    ...
    hunter_asset_api, claude_api, opencode_api
)
...
routes = {
    ...
    "/api/getMySessions": auth_api.get_my_sessions,
    "/api/logoutCurrentSession": auth_api.logout_current_session,
    "/api/logoutOtherSessions": auth_api.logout_other_sessions,
    "/api/logoutSessionById": auth_api.logout_session_by_id,
    ...
    '/api/getDeployWebhook': certificate_api.get_deploy_webhook,
    ...
    # Hunter 资产
    '/api/importHunterAssetCsv': hunter_asset_api.import_hunter_asset_csv,
    '/api/triggerAssetClassification': hunter_asset_api.trigger_asset_classification,
    '/api/triggerFullAssetPipeline': hunter_asset_api.trigger_full_asset_pipeline,
    '/api/getClassifiedAssets': hunter_asset_api.get_classified_assets,
    '/api/updateClassifiedAssetStatus': hunter_asset_api.update_classified_asset_status,
    '/api/updateClassifiedAssetRemark': hunter_asset_api.update_classified_asset_remark,

    # Claude
    '/api/createClaudeConversation': claude_api.create_claude_conversation,
    '/api/getClaudeConversations': claude_api.get_claude_conversations,
    '/api/getClaudeMessages': claude_api.get_claude_messages,
    '/api/sendClaudeMessage': claude_api.send_claude_message,
    '/api/deleteClaudeConversation': claude_api.delete_claude_conversation,
    '/api/renameClaudeConversation': claude_api.rename_claude_conversation,
    '/api/getClaudeMcpStatus': claude_api.get_claude_mcp_status,

    # OpenCode
    '/api/opencodeExecute': opencode_api.opencode_execute,
    '/api/opencodeTaskList': opencode_api.opencode_task_list,
    '/api/opencodeTaskDetail': opencode_api.opencode_task_detail,
    '/api/opencodeRetryTask': opencode_api.opencode_retry_task,
    '/api/opencodeCancelTask': opencode_api.opencode_cancel_task,
    '/api/opencodeHealth': opencode_api.opencode_health,
    '/api/opencodeMetrics': opencode_api.opencode_metrics,
    '/api/opencodeStream': opencode_api.opencode_stream,
    '/api/opencodeCreateSession': opencode_api.opencode_create_session,
    '/api/opencodeDeleteSession': opencode_api.opencode_delete_session,
    '/api/opencodeRenameSession': opencode_api.opencode_rename_session,
    '/api/opencodeSessionList': opencode_api.opencode_session_list,
    '/api/opencodeSessionMessages': opencode_api.opencode_session_messages,
}
