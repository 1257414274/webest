...
from domain_admin.model import base_model, domain_icp_model, tag_model, certificate_model, deploy_cert_model, dns_model, \
    deploy_webhook_model
from domain_admin.model import (
    address_model,
    claude_conversation_model,
    claude_message_model,
    log_operation_model,
    group_user_model,
...
tables = [
    ...
    (user_session_model.UserSessionModel, None),
    ...
    (deploy_webhook_model.DeployWebhookModel, None),
    (hunter_asset_model.HunterAssetModel, None),
    (claude_conversation_model.ClaudeConversationModel, None),
    (claude_message_model.ClaudeMessageModel, None),
    (opencode_task_model.OpencodeTaskModel, None),
]
